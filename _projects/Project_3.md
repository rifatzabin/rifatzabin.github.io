...
<div class="row">
  <div class="col-sm mt-3 mt-md-0">
    {% include figure.html path="assets/img/high_activity.png" title="High Activity CFR" class="img-fluid rounded z-depth-1" %}
  </div>
</div>
<div class="caption">
...
<div class="row">
  <div class="col-sm mt-3 mt-md-0">
    {% include figure.html path="assets/img/cnn_tsne.png" title="t-SNE Clusters" class="img-fluid rounded z-depth-1" %}
  </div>
</div>
<div class="caption">
...
📄 [Download Paper (PDF)](/assets/papers/PULSE_Framework.pdf)  
💻 [View Source on GitHub](https://github.com/yourusername/pulse)
